...
class Programa(models.Model):
    # Opciones de Nivel de Formación (image_9a6390.jpg)
    ...
    # Opciones de Modalidad (image_9a6390.jpg)
    MODALIDAD_CHOICES = [
        ('PRE', 'Presencial'),
        ('VIR', 'Virtual'),
        ('MIX', 'Mixta'),
    ...
    # Opciones de Estado (image_9a6373.jpg)
    ESTADO_CHOICES = [
        ('ACT', 'Activo'),
        ('INA', 'Inactivo'),
        ('SUS', 'Suspendido'),
    ...
    # Campos del Modelo Programa (image_9a11f9.jpg)
