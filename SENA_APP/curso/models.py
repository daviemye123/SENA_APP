...
class curso(models.Model):
    ...
    programa = models.ForeignKey('programa.Programa', on_delete=models.CASCADE, verbose_name="Programa de Formación")
...
class AprendizCurso(models.Model):
    ...
    aprendiz = models.ForeignKey('aprendices.aprendices', on_delete=models.CASCADE)
    curso = models.ForeignKey(curso, on_delete=models.CASCADE)
